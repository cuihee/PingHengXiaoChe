...
void oled_show(void)
{
  	...
  	//=============显示编码器2=======================//		
		...
		//=============显示角度=======================//
		                      OLED_ShowString(01,50,"Angle");
		if(Angle_Balance<0)		OLED_ShowNumber(45,50,0-Angle_Balance,4,12),
